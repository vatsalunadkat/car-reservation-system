...
from vehicle_register.views import UpdateVehicleView
import jwt
import datetime
...
class RetrieveBookingView(APIView):
    def get(self, request):
        ...
        if booking is None:
            return Response({'status': 'FAILED', "data": "This user has no bookings"})
...
class CancelBookingView(APIView):
    def get(self, request):
        ...
        return Response({'status': 'SUCCESS', 'data': serializer_save.data})
